# Generated by Powerlevel10k configuration wizard on 2020-05-19 at 23:23 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON='\uF126 ' # "Y" git branch shape
  ...
  typeset -g POWERLEVEL9K_VCS_STASH_ICON='\uF01C ' # "inbox" icon
  typeset -g POWERLEVEL9K_VCS_INCOMING_CHANGES_ICON='\uF01A ' # (v)
  typeset -g POWERLEVEL9K_VCS_OUTGOING_CHANGES_ICON='\uF01B ' # (^)

  typeset -g POWERLEVEL9K_VCS_TAG_ICON='\uF02B ' # "tag"/"label" icon
  typeset -g POWERLEVEL9K_VCS_COMMIT_ICON='\uE729 ' # -o-
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${clean}${(g::)POWERLEVEL9K_VCS_INCOMING_CHANGES_ICON}${VCS_STATUS_PUSH_COMMITS_BEHIND}"
    (( VCS_STATUS_PUSH_COMMITS_AHEAD && !VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" "
    # ⇢42 if ahead of the push remote; no leading space if also behind: ⇠42⇢42.
    (( VCS_STATUS_PUSH_COMMITS_AHEAD  )) && res+="${clean}${(g::)POWERLEVEL9K_VCS_OUTGOING_CHANGES_ICON}${VCS_STATUS_PUSH_COMMITS_AHEAD}"
    # *42 if have stashes.
